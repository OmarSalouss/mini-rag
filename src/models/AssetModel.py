...
class AssetModel(BaseDataModel):
    ...
    async def create_asset(self, asset: Asset):
        ...
        result = await self.collection.insert_one(asset.dict(by_alias=True, exclude_unset=True)) # `asset.dict` : To convert pydantic schema to dictionary that understand by MongoDB
